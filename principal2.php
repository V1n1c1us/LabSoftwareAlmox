            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#demo">
                        <i class="fa fa-fw fa-arrows-v"></i> Cadastro <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="demo" class="collapse">
                        <li>
                            </i><a href="#"><i class="fa fa-fw fa-user"></i> Novo Usuaário</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-fw fa-barcode"></i> Novo Produto</a>
                        </li>
                    </ul>
                </li>
                <li>
...
<!--<div class="modal fade modal-lg" id="modalRealizaPedido" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">-->
